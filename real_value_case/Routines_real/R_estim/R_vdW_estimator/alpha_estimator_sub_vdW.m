function [alpha_est, Delta_T, Psi_T] = alpha_estimator_sub_vdW(y, T, V, M_n, N_n)
...
[Delta_T, Psi_T] = Delta_Psi_eval_vdW(y, T, M_n);

% Evaluation of the perturbed approximation of the efficient central sequence Delta_T
T_pert = T + V/sqrt(K);
Delta_T_pert = Delta_only_eval_vdW(y, T_pert, M_n);
